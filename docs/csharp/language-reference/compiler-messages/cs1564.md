...
- [**Win32Manifest** (параметры компилятора C#)](../compiler-options/resources.md#win32manifest)
- [**Win32Resource** (параметры компилятора C#)](../compiler-options/resources.md#win32resource)
