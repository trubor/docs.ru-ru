...
Наконец, записи поддерживают [выражения `with`](../language-reference/operators/with-expression.md). ***Выражение `with`** _ указывает компилятору создать копию записи, но _с* указанными измененными свойствами.
...
Дополнительные сведения о типах записей см. в этом учебнике по [исследованию записей](../whats-new/tutorials/records.md).
