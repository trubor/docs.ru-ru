...
Требуется disable или restore  
 ...
 Эта ошибка возникает, если предложение #pragma warning неправильно сформировано — например, если пропущено disable или restore. Дополнительные сведения см. в разделе [#pragma warning](../language-reference/preprocessor-directives.md#pragma-warning) .  
