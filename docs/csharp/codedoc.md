...
---
# <a name="document-your-c-code-with-xml-comments"></a>Документирование кода C# с помощью XML-комментариев
...
- Если вы компилируете приложение .NET из командной строки, добавьте [параметр компилятора **DocumentationFile**](language-reference/compiler-options/output.md#documentationfile).  
