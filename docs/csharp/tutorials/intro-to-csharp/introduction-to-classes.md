...
## <a name="define-the-bank-account-type"></a><span data-ttu-id="f2159-134">Определение типа банковского счета</span><span class="sxs-lookup"><span data-stu-id="f2159-134">Define the bank account type</span></span>
