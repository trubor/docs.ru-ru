...
- [Ешопондапр на GitHub](https://github.com/dotnet-architecture/eShopOnDapr)

- [eShopOnContainers на GitHub](https://github.com/dotnet-architecture/eShopOnContainers)
