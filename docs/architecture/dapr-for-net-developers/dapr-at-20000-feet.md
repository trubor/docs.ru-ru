...
Дополнительные сведения см. в [обзоре gRPC](../cloud-native/grpc.md#what-is-grpc) в разделе [проектирование архитектуры Cloud-Native приложений .NET для электронной документации по Azure](../cloud-native/index.md) .  
