...
<span data-ttu-id="1e9cf-114">Различают следующие подкатегории правил стиля кода:</span><span class="sxs-lookup"><span data-stu-id="1e9cf-114">Code style rules are divided into following subcategories:</span></span>
