...
Это правило похоже на [CA2311](ca2311.md), но анализ не может определить, что свойство <xref:System.Runtime.Serialization.NetDataContractSerializer.Binder> точно имеет значение NULL.
