...
Десериализация с сериализованным <xref:System.Runtime.Serialization.IFormatter?displayProperty=nameWithType>, и граф объектов приведенного типа может включать <xref:System.Data.DataSet> или <xref:System.Data.DataTable>.

Это правило использует другой подход по сравнению с похожим правилом [CA2352: небезопасные данные DataSet или DataTable в сериализуемом типе могут быть уязвимыми для атак с удаленным выполнением кода](ca2352.md).
