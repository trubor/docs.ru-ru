...
Дополнительные сведения о различных задачах Машинного обучения, поддерживаемых ML.NET, см. в статье [Задачи машинного обучения в ML.NET](resources/tasks.md).
