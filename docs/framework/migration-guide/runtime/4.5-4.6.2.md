...
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="61e1a-103">Изменение среды выполнения для миграции с .NET Framework 4.5 на 4.6.2</span><span class="sxs-lookup"><span data-stu-id="61e1a-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="61e1a-104">Если выполняется миграция с .NET Framework версии 4.5 на 4.6.2, просмотрите следующие разделы о проблемах совместимости приложений, которые могут повлиять на работу приложения:</span><span class="sxs-lookup"><span data-stu-id="61e1a-104">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="61e1a-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="61e1a-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="61e1a-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="61e1a-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="61e1a-107">Ядро</span><span class="sxs-lookup"><span data-stu-id="61e1a-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="61e1a-108">Данные</span><span class="sxs-lookup"><span data-stu-id="61e1a-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="61e1a-109">Отладчик</span><span class="sxs-lookup"><span data-stu-id="61e1a-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="61e1a-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="61e1a-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="61e1a-111">Глобализация</span><span class="sxs-lookup"><span data-stu-id="61e1a-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="61e1a-112">Сети</span><span class="sxs-lookup"><span data-stu-id="61e1a-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="61e1a-113">Безопасность</span><span class="sxs-lookup"><span data-stu-id="61e1a-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="61e1a-114">Сериализация</span><span class="sxs-lookup"><span data-stu-id="61e1a-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="61e1a-115">Установка и развертывание</span><span class="sxs-lookup"><span data-stu-id="61e1a-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="61e1a-116">Инструменты</span><span class="sxs-lookup"><span data-stu-id="61e1a-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="61e1a-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="61e1a-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="61e1a-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="61e1a-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="61e1a-119">XML</span><span class="sxs-lookup"><span data-stu-id="61e1a-119">XML</span></span>
