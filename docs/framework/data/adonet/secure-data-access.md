...
## <a name="enterprise-services"></a>Корпоративные службы  
 ...
 COM+ содержит собственную модель безопасности, основанную на учетных записях Windows и олицетворении процессов и потоков. Пространство имен <xref:System.EnterpriseServices> предоставляет оболочки, позволяющие приложениям .NET встраивать управляемый код со службами безопасности COM+ с помощью класса <xref:System.EnterpriseServices.ServicedComponent>.  
