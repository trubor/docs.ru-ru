...
Дополнительные сведения см. в разделе [хорошо известные идентификаторы безопасности](/troubleshoot/windows-server/identity/security-identifiers-in-windows).  
